...
const Commentcard = ({
    ...
    const fetchReply = async () => {
      ...
      axios
        .get(
          ...
          }/stores/${storeId}/reviews/${reviewId}/comments/${comment._id}`
        )
        .then((response) => {
  ...
  const handleReport = async () => {
    ...
    axios
      .post(
        `${import.meta.env.VITE_BACKEND_URL}/users/${comment.userId._id
        }/report`,
        {},
        {
          headers: {
  ...
  const toggleLike = async () => {
    if (!!role) {
      ...
      axios
        .post(
          `${import.meta.env.VITE_BACKEND_URL
          }/stores/${storeId}/reviews/${reviewId}/comments/${comment._id}/like`,
          {},
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
      ...
      <div
        ...
        <div className="flex gap-2 items-center my-2">
          <Button
            ...
            title="like"
            size="sm"
            className={`flex rounded-full p-2 ${isLiked &&
