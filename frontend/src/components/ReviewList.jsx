...
const ReviewList = ({ store, userReplyCounter, setUserReplyCounter }) => {
  ...
  return (
            <section className="w-full max-w-5xl m-auto mt-5 rounded-2xl overflow-hidden shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] transition-all duration-300">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 text-sm py-4 my-2 border-b-2 border-slate-200   dark:border-zinc-800">
        <div className="flex flex-col justify-center p-4 pl-10 sm:pl-4 rounded-2xl border-2 border-slate-200 dark:border-zinc-800 shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] transition-all duration-300">
        ...
        <div className="flex flex-col sm:col-span-2 md:col-span-1 gap-2 justify-center p-4 rounded-2xl border-2 border-slate-200 dark:border-zinc-800 shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] transition-all duration-300">
